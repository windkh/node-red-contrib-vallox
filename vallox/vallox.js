...
const VALLOX_FAN_SPEED_MAPPING = [0x01, 0x03, 0x07, 0x0f, 0x1f, 0x3f, 0x7f, 0xff];
...
const VALLOX_TEMPERATURE_MAPPING = [
    -74, -70, -66, -62, -59, -56, -54, -52, -50, -48, -47, -46, -44, -43, -42, -41, -40, -39, -38, -37, -36, -35, -34,
    -33, -33, -32, -31, -30, -30, -29, -28, -28, -27, -27, -26, -25, -25, -24, -24, -23, -23, -22, -22, -21, -21, -20,
    -20, -19, -19, -19, -18, -18, -17, -17, -16, -16, -16, -15, -15, -14, -14, -14, -13, -13, -12, -12, -12, -11, -11,
    -11, -10, -10, -9, -9, -9, -8, -8, -8, -7, -7, -7, -6, -6, -6, -5, -5, -5, -4, -4, -4, -3, -3, -3, -2, -2, -2, -1,
    -1, -1, -1, 0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 4, 5, 5, 5, 5, 6, 6, 6, 7, 7, 7, 8, 8, 8, 9, 9, 9, 10, 10, 10,
    11, 11, 11, 12, 12, 12, 13, 13, 13, 14, 14, 14, 15, 15, 15, 16, 16, 16, 17, 17, 18, 18, 18, 19, 19, 19, 20, 20, 21,
    21, 21, 22, 22, 22, 23, 23, 24, 24, 24, 25, 25, 26, 26, 27, 27, 27, 28, 28, 29, 29, 30, 30, 31, 31, 32, 32, 33, 33,
    34, 34, 35, 35, 36, 36, 37, 37, 38, 38, 39, 40, 40, 41, 41, 42, 43, 43, 44, 45, 45, 46, 47, 48, 48, 49, 50, 51, 52,
    53, 53, 54, 55, 56, 57, 59, 60, 61, 62, 63, 65, 66, 68, 69, 71, 73, 75, 77, 79, 81, 82, 86, 90, 93, 97, 100, 100,
...
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.IOPORT_FANSPEED_RELAYS] = {
    name: 'IoPortFanSpeedRelays',
    readonly: true,
    command: Variables.IOPORT_FANSPEED_RELAYS,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.IOPORT_MULTI_PURPOSE_1] = {
    name: 'IoPortMultiPurpose1',
    readonly: true,
    command: Variables.IOPORT_MULTI_PURPOSE_1,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.IOPORT_MULTI_PURPOSE_2] = {
    name: 'IoPortMultiPurpose2',
    readonly: true,
    command: Variables.IOPORT_MULTI_PURPOSE_2,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.FAN_SPEED] = {
    name: 'FanSpeed',
    readonly: false,
    command: Variables.FAN_SPEED,
};
...
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.CURRENT_INCOMMING] = {
    name: 'CurrentIncoming',
    readonly: true,
    command: Variables.CURRENT_INCOMMING,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.HUMIDITY_SENSOR1] = {
    name: 'HumiditySensor1',
    readonly: true,
    command: Variables.HUMIDITY_SENSOR1,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.HUMIDITY_SENSOR2] = {
    name: 'HumiditySensor2',
    readonly: true,
    command: Variables.HUMIDITY_SENSOR2,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.TEMP_OUTSIDE] = {
    name: 'TemperatureOutside',
    readonly: true,
    command: Variables.TEMP_OUTSIDE,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.TEMP_EXHAUST] = {
    name: 'TemperatureExhaust',
    readonly: true,
    command: Variables.TEMP_EXHAUST,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.TEMP_INSIDE] = {
    name: 'TemperatureInside',
    readonly: true,
    command: Variables.TEMP_INSIDE,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.TEMP_INCOMMING] = {
    name: 'TemperatureIncoming',
    readonly: true,
    command: Variables.TEMP_INCOMMING,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.LAST_ERROR_NUMBER] = {
...
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.POST_HEATING_OFF_TIME] = {
    name: 'PostHeatingOffTime',
    readonly: false,
...
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.HEATING_SET_POINT] = {
    ...
    readonly: false,
    command: Variables.HEATING_SET_POINT,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.FAN_SPEED_MAX] = {
    name: 'FanSpeedMax',
    readonly: false,
    command: Variables.FAN_SPEED_MAX,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.SERVICE_REMINDER] = {
    name: 'ServiceReminder',
    readonly: false,
    command: Variables.SERVICE_REMINDER,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.PRE_HEATING_SET_POINT] = {
    name: 'PreHeatingSetPoint',
    readonly: false,
    command: Variables.PRE_HEATING_SET_POINT,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.INPUT_FAN_STOP] = {
    name: 'InputFanStop',
    readonly: false,
    command: Variables.INPUT_FAN_STOP,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.FAN_SPEED_MIN] = {
    name: 'FanSpeedMin',
    readonly: false,
    command: Variables.FAN_SPEED_MIN,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.PROGRAM] = { name: 'Program', readonly: false, command: Variables.PROGRAM };
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.MAINTENANCE_MONTH_COUNTER] = {
    name: 'MaintenanceMonthCounter',
    readonly: false,
    command: Variables.MAINTENANCE_MONTH_COUNTER,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.BASIC_HUMIDITY_LEVEL] = {
    name: 'BasicHumidityLevel',
    readonly: false,
    command: Variables.BASIC_HUMIDITY_LEVEL,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.HRC_BYPASS] = {
    name: 'HRCBypass',
    readonly: false,
    command: Variables.HRC_BYPASS,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.DC_FAN_INPUT_ADJUSTMENT] = {
    name: 'DCFanInputAdjustment',
    readonly: false,
    command: Variables.DC_FAN_INPUT_ADJUSTMENT,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.DC_FAN_OUTPUT_ADJUSTMENT] = {
    name: 'DCFanOutputAdjustment',
    readonly: false,
    command: Variables.DC_FAN_OUTPUT_ADJUSTMENT,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.CELL_DEFROSTING_HYSTERESIS] = {
    name: 'CellDefrostingHysteresis',
    readonly: false,
    command: Variables.CELL_DEFROSTING_HYSTERESIS,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.CO2_SET_POINT_UPPER] = {
    name: 'CO2SetPointUpper',
    readonly: false,
    command: Variables.CO2_SET_POINT_UPPER,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.CO2_SET_POINT_LOWER] = {
    name: 'CO2SetPointLower',
    readonly: false,
    command: Variables.CO2_SET_POINT_LOWER,
};
VALLOX_COMMAND_VARIABLE_MAPPING[Variables.PROGRAM2] = {
    name: 'Program2',
    readonly: false,
    command: Variables.PROGRAM2,
};
